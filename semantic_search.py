...
class EmbeddingRetriever:
    ...
    def __init__(self, model_name: str = 'all-MiniLM-L6-v2'):
        ...
        try:
            ...
            print("SentenceTransformer not available. Semantic search will be disabled.")
    ...
    def search(self, query: str, k: int = 5) -> List[Tuple[str, float]]:
        ...
        """
        if not self.embedding_available or not self.corpus or not self.embeddings is not None:
            return []
    ...
    def reset(self):
        ...
        if self.embedding_cache_path.exists():
            try:
                ...
                print(f"Error removing embeddings cache: {str(e)}")